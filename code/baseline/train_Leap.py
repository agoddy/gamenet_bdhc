...
def eval(model, data_eval, voc_size, epoch):
    ...
    for step, input in enumerate(data_eval):
        ...
        y_pred_label_array = np.array(y_pred_label)
        adm_ja, adm_prauc, adm_avg_p, adm_avg_r, adm_avg_f1 = sequence_metric(y_gt_array, y_pred_array, y_pred_prob_array, y_pred_label_array)
        ja.append(adm_ja)
