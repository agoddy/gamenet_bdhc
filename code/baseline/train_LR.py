...
def create_dataset(data, diag_voc, pro_voc, med_voc):
    '''
    Input :  diag ,pcuder and medical vocabulary 

    Construct a single vector of diagnoses and proceudres in muti hot encoded foramt
...
def main():
    ...
    # do the prediction and get result
